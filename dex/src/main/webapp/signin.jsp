...
<html>
<head>
<title>DexChallenge | Sign-in</title>
...
<li><a href="Chat.jsp">Chat with us</a></li>
	...
	<form action="UserController" method="POST">
		...
		<table style="align:center;width:100%;">
			<tr>
				<td colspan="2" align="center" style="color:#5DADE2;font-size:large;">SIGN IN</td>
			</tr>
			<tr>
			...
			<tr>
				<td align="right" width="50%">Phone Number -</td>
				<td width="50%"><input type="text" name="phno" /></td>
			</tr>
			<tr>
			...
			<tr>
				<td align="right" width="50%"></td>
				<td width="50%">Already Registered?<a href="login.jsp">Login here</a></td>
			</tr>
		</table>
		</div>
	</form>
